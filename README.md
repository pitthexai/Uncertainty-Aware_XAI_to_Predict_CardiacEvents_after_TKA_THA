...
+ <p align="justify"><strong>Code:</strong> This directory contains all Python scripts and notebooks used for model training, evaluation, and explainability analyses.</p>  
+ <p align="justify"><strong>Dataset:</strong> This directory used the NSQIP dataset, focusing on patient-level clinical features.</p>  
+ <p align="justify"><strong>Figures:</strong> This directory contains figures and visualizations generated for the study, including performance plots and explainability results.</p>  
+ <p align="justify"><strong>Models:</strong> This directory includes the trained AI models and related configuration files.</p>  
+ <p align="justify"><strong>Presentation:</strong> This directory contains presentation slides for communicating project results.</p>

### The Proposed Computational Pipeline 
<p align="center">
  <img src="Figures/fig03_shap_TKA.png" alt="SHAP summary for TKA" width="300" height="300"/>
  <img src="Figures/fig05_uncertainty_TKA.png" alt="Uncertainty Quantification for TKA" width="300" height="700"/>
</p>
...
<p align="justify">
  <strong>Trustworthy and Uncertainty-Aware AI for Predicting Respiratory Complications Following TKA/THA</strong><br/>
